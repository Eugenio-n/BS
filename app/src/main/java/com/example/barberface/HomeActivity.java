package com.example.barberface;
...
import com.example.barberface.Common.Common;
import com.example.barberface.Fragments.HomeFragment;
import com.example.barberface.Fragments.ShoppingFragment;
import com.example.barberface.Model.User;
...
//                                    bottomNavigationView.setSelectedItemId(R.id.action_home);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.action_home) // (menuItem. ...
